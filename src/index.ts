...
server.tool(
  ...
  async ({ baseURL, endpoint,username, password }: { baseURL: string; endpoint: string; username: string; password: string }) => {
    try {
...
server.tool(
  ...
  async ({ baseURL, endpoint, params }: { baseURL: string; endpoint: string; params?: Record<string, string> }) => {
    try {
...
server.tool(
  ...
  async ({ baseURL, endpoint, payload }: { baseURL: string; endpoint: string, payload: string }) => {
    try {
...
server.tool(
  ...
  async ({ baseURL, endpoint, token, payload }: { baseURL: string; endpoint: string; token: string; payload: string}) => {
    try {
        const data= JSON.parse(payload);
...
server.tool(
  ...
  async ({ baseURL, endpoint, token}: { baseURL: string; endpoint: string; token: string}) => {
    try {
